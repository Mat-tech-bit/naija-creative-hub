      ...
      {positions.map((pos, displayIndex) => {
        ...
        return (
          ...
          >
            ...
            <p className="text-center font-bold mt-2 text-sm sm:text-base truncate w-24 sm:w-32">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-1 text-sm text-muted-foreground font-medium">
                ...
                <span className="capitalize">{contestant.category.replace("graphics", "Graphics").replace("fashion", "Fashion").replace("photography", "Photography")}</span>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-4">
              ...
              <span className="text-sm font-bold">Live Rankings</span>
          ...
          <div className="glass rounded-2xl p-4 sm:p-6 shadow-xl">
            <div className="flex items-center justify-between mb-4 px-4 font-bold">
            ...
            {filteredContestants.length === 0 && (
              <div className="text-center py-12">
                <p className="text-muted-foreground font-medium">No contestants found</p>
              </div>
            )}
          </div>
        </div>
